...
wp plugin install --activate --force \
    ...
    https://github.com/co-cart/co-cart/archive/v2.0.0-beta.2.zip \
    custom-post-type-ui \
    ...
    https://github.com/wp-premium/woocommerce-table-rate-shipping/archive/master.zip \
    wordpress-importer \
    https://github.com/roots/wp-password-bcrypt/archive/master.zip \
